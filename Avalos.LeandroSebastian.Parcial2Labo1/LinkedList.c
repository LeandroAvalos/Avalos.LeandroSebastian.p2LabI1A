...
/** \brief Devuelve la linkedlist con valores cargados aleatoriamente
 *
 * \param LinkedList* this linkedlist a cargar con valores aleatorios.
 * \param void*(*pFunc) (void* elemento) puntero a la funcion que genera los valores aleatorios
 * \return retorna la linkedlist cargada con los valores aleatorios
 *
 */
